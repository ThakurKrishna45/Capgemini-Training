...
public class Task2 {
    public static void main(String[] args) {
        ...
        List<Integer> out= emp.stream().filter(e->(e.getYearsOfExperience()<=5 && e.getPerformanceRating()<8 && e.getSalary()>=60000 &&
                e.getSalary()<=120000)).sorted(Comparator.comparing(Employee::getSalary).
                        thenComparing(Employee::getYearsOfExperience).reversed()).
                            map(e->(e.getId()*10)).collect(Collectors.toList());
